...
const scope = "none"
const telemetryInfo = "azsdk-go-azeventgrid/<version>"
...
func newConnection(topicHostname string, cred azcore.Credential, options *connectionOptions) *connection {
	if options == nil {
	...
	return &connection{u: topicHostname, p: azcore.NewPipeline(options.HTTPClient, policies...)}
}
